...
(let (arr/372 = (apply (field_imm 0 (global Toploop!)) "arr"))
  (iarray.get[int indexed by int, array kind int] arr/372 1))
- : int = 2
|}]
...
[%%expect {|
(let (arr/372 = (apply (field_imm 0 (global Toploop!)) "arr"))
  (iarray.unsafe_get[int indexed by int, array kind int] arr/372 1))
- : int = 2
|}]
...
(let (mut_arr/379 = (apply (field_imm 0 (global Toploop!)) "mut_arr"))
  (array.get[int indexed by int, array kind int] mut_arr/379 1))
- : int = 2
|}]
...
[%%expect {|
(let (mut_arr/379 = (apply (field_imm 0 (global Toploop!)) "mut_arr"))
  (array.unsafe_get[int indexed by int, array kind int] mut_arr/379 1))
- : int = 2
|}]
...
(let (mut_arr/429 = (apply (field_imm 0 (global Toploop!)) "mut_arr"))
  (array.get[int indexed by int, array kind int] mut_arr/429 1))
- : int = 2
|}]
...
[%%expect {|
(let (mut_arr/429 = (apply (field_imm 0 (global Toploop!)) "mut_arr"))
  (array.unsafe_get[int indexed by int, array kind int] mut_arr/429 1))
- : int = 2
|}]
...
(let (mut_arr/431 = (apply (field_imm 0 (global Toploop!)) "mut_arr"))
  (array.get[int indexed by int, array kind int] mut_arr/431 1))
- : int = 2
|}]
...
[%%expect {|
(let (mut_arr/431 = (apply (field_imm 0 (global Toploop!)) "mut_arr"))
  (array.unsafe_get[int indexed by int, array kind int] mut_arr/431 1))
- : int = 2
|}]
