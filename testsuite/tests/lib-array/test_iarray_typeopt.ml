...
(let (arr/377 = (apply (field_imm 0 (global Toploop!)) "arr"))
  (iarray.get[int indexed by int, array kind int] arr/377 1))
- : int = 2
|}]
...
[%%expect {|
(let (arr/377 = (apply (field_imm 0 (global Toploop!)) "arr"))
  (iarray.unsafe_get[int indexed by int, array kind int] arr/377 1))
- : int = 2
|}]
...
(let
  (mut_arr/386 = (apply (field_imm 0 (global Toploop!)) "mut_arr")
   arr/387 =
     (apply (field_imm 13 (global Stdlib_stable__Iarray!)) mut_arr/386))
...
let _ = mut_arr.(1);;
[%%expect {|
(let (mut_arr/388 = (apply (field_imm 0 (global Toploop!)) "mut_arr"))
  (array.get[int indexed by int, array kind int] mut_arr/388 1))
- : int = 2
|}]
...
[%%expect {|
(let (mut_arr/388 = (apply (field_imm 0 (global Toploop!)) "mut_arr"))
  (array.unsafe_get[int indexed by int, array kind int] mut_arr/388 1))
- : int = 2
|}]
...
0
type 'a alias = 'a array
(let (mut_arr/440 =[intarray] (makearray[int] 1 2 3))
...
(let (mut_arr/440 = (apply (field_imm 0 (global Toploop!)) "mut_arr"))
  (array.get[int indexed by int, array kind int] mut_arr/440 1))
- : int = 2
|}]
...
[%%expect {|
(let (mut_arr/440 = (apply (field_imm 0 (global Toploop!)) "mut_arr"))
  (array.unsafe_get[int indexed by int, array kind int] mut_arr/440 1))
- : int = 2
|}]
...
[%%expect {|
(let (arr/441 = (makearray_imm[int] 1 2 3))
  (apply (field_imm 1 (global Toploop!)) "arr" arr/441))
val arr : int iarray = [:1; 2; 3:]
(let
  (arr/441 = (apply (field_imm 0 (global Toploop!)) "arr")
   mut_arr/442 =[intarray]
     (apply (field_imm 12 (global Stdlib_stable__Iarray!)) arr/441))
