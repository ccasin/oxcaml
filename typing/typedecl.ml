  ...
  | Some ty, _ ->
    ...
    | None -> begin
        ...
        match
          ...
          ~level:(Ctype.get_current_level ()) env manifest_jkind decl.type_jkind
        with
        | Ok () -> ()
...
let transl_jkind_constraint id env (orig_decl : Types.jkind_declaration)
      new_decl =
  ...
  let jkind_jkind =
    { jkind_manifest;
      jkind_attributes = orig_decl.jkind_attributes;
      jkind_uid;
